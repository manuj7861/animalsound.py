...
class Dog(Animal):
    # Step 3: Override the make_sound() method in the Dog class with the dog sound (bark)
    def make_sound(self):
        print("Bark")

class Cat(Animal):
    # Step 3: Override the make_sound() method in the Cat class with the cat sound (meow)
    def make_sound(self):
        print("Meow")
